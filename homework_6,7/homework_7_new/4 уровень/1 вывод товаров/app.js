...
function clickHandler(event) {
    ...
    let dataTypeAtr = event.target.dataset.type;
    showCategory(dataTypeAtr);
}
...
function showCategory(category) {
    if (category === 'phones'){
        prod.insertAdjacentHTML("afterbegin", getProductMarkup(products.phones));
    }
    if (category === 'tablets'){
        prod.insertAdjacentHTML("afterbegin", getProductMarkup(products.tablets));
    }
    if (category === 'tv'){
        prod.insertAdjacentHTML("afterbegin", getProductMarkup(products.tv));
    }
}
