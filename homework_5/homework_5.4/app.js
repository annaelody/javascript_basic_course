...
// 1.1 затем проитерируйтесь по кнопкам и каждой из них добавьте обработчик клика - функцию handleClick
...
function handleClick(clickedButtonEvent) {
    const cardNode = clickedButtonEvent.target.parentNode; // 2. из объекта события получите ссылку на .product и сохраните в переменную: const cardNode = ;
    const card = { // 3. создайте литерал объекта со следующими свойствами:
    ...
    const textOnButton = card.button.innerText;// 4. получаем текст на кнопке, которая внутри .product
...
function showMoreText(card) {
    ...
    const text = "Lorem  ipsum dolor sit amet, consectetur ipsum dolor sit amet consectetur."; // 6.1 сохраняем произвольный текст в переменную
